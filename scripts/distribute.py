...
def do_binpack_constvol(bp_dict, max_vol=100*1024):
	...
	assert max_vol >= max(bp_dict.values()), """Maximum volume for 
			binpacking must be larger than the largest file"""
...
if __name__ == "__main__":
	...
	if args.constbin:
		print(do_binpack_constbin(filesizes_map, args.constbin))
	elif args.constvol:
		print(do_binpack_constvol(filesizes_map, args.constvol))
	else: # args.distribution
		print(do_binpack_distribution(filesizes_map, args.distribution))
